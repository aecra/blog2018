...
<div style="margin-left:65px;padding-top:55px">
	<div style="margin: 20px;">
        ...
        <div id="addblock"><a href="add.php" id="addblockfont">我有新的随笔</a></div>
        ...
        <table style="width: 80%" class="table"> 
            ...
            <?php
                $sql = 'SELECT * FROM suibi ORDER BY TIME DESC ';
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    //删除表单
                    echo '<td style="display:flex;justify-content: center;align-items: center;"><form method="post" action="delete.php?page=2" onsubmit="return sumbit_sure()"><input type="hidden" name="time" value="'.$row['time'].'"><input type="submit" style="width: 40px;background-color: width;border:none;" value="删除"></form></td>';
                    echo "</tr>";
                }
